...
public class view_tra extends JFrame {
	...
	public view_tra() {
		...
		String thoi_gian_tra = tg.tg_tra();

		tg_textField = new JTextField(thoi_gian_tra);
		...
		btnNewButton.setBounds(10, 337, 142, 50);
		contentPane.add(btnNewButton);

		JButton cb_Button = new JButton("Quay lại");
		cb_Button.setBounds(170, 337, 142, 50);
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				String ngt = nguoi_tra_textField.getText();
				String TD = tieu_de_textField.getText();
				String id = id_textField.getText();

				if (!ngt.isEmpty() && !TD.isEmpty() && !id.isEmpty()) {

					String fileName = "C:\\Users\\THANH\\Desktop\\GK_OOP\\data_tra.txt";

					try (BufferedWriter writer = new BufferedWriter(new FileWriter(fileName, true))) {
						writer.write("người trả: " + ngt + "\n");
						writer.write("tiêu đề sách: " + TD + "\n");
						writer.write("id sách: " + id + "\n");
						writer.write("thời gian trả: " + thoi_gian_tra + "\n");
